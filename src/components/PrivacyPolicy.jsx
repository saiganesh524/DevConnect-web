      ...
      <div className="flex justify-center my-10">
        <div className="card bg-base-300 shadow-xl">
          <div className="card-body">
            ...
            <p>
              This privacy policy sets out how SAI GANESH uses and protects any
              information that you give SAI GANESH when you visit their website
              and/or agree to purchase from them.
            </p>
            <p>
              SAI GANESH is committed to ensuring that your privacy is
            ...
            <p>
              SAI GANESH may change this policy from time to time by updating
            ...
            <ul className="mx-12 list-disc">
              <li className="leading-8">Name</li>
            ...
            <ul className="mx-12 list-disc">
              <li className="leading-8">Internal record keeping.</li>
              <li className="leading-8">
            ...
            <p>
              ...
              incorrect or incomplete, please write or contact us at
              support@linkdev.info as soon as possible. We will promptly correct
